...
class ClassicFireworkController {
    ...
    func addFireworks(count fireworksCount: Int = 1, sparks sparksCount: Int, around sourceView: UIView, sparkSize: CGSize =  CGSize(width: 17, height: 17), scale: CGFloat = 65.0, maxVectorChange: CGFloat = 15.0, animationDuration: TimeInterval = 0.6, canChangeZIndex: Bool = true) {
