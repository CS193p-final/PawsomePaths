...
class ClassicFireworkController {
    ...
    func addFireworks(count fireworksCount: Int = 1, sparks sparksCount: Int, around sourceView: UIView, sparkSize: CGSize =  CGSize(width: 7, height: 7), scale: CGFloat = 45.0, maxVectorChange: CGFloat = 15.0, animationDuration: TimeInterval = 0.4, canChangeZIndex: Bool = true) {
...
//        }
        ...
        for _ in 0..<fireworksCount {
            ...
            for sparkIndex in 0..<sparksCount {
                ...
                sourceView.addSubview(spark.sparkView)
